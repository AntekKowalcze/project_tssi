/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism-dark&languages=markup+css+clike+javascript+css-extras+diff&plugins=line-highlight+line-numbers+autolinker+wpd+custom-class+show-language+highlight-keywords+remove-initial-line-feed+inline-color+previewers+autoloader+keep-markup+command-line+unescaped-markup+toolbar+copy-to-clipboard+download-button+match-braces+diff-highlight */
var _self =
