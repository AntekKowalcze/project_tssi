...
var funFactDictionary ={
  "#CSS1" : "Główną osią display:flex; jest oś posioma, chyba że zmienisz flex-direction: na column!",
  "#HTML1" : "Możesz użyć atrybutu download w <a> aby określić, że zawartość linku zostanie pobrana!",
